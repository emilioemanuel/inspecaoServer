package br.com.oratech.inspectsys.config;
...
@Configuration
@EnableMongoRepositories("br.com.oratech.inspectsys.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("br.com.oratech.inspectsys.config.dbmigrations");
